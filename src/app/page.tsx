...
const categories = [
  ...
  {
    title: "Overshirts",
    copy: "Easy outer layers",
    href: "/products?category=Overshirts",
    image:
    ...
    <div className="reference-home">
      ...
      <section className="ref-shell ref-ideas">
        <div className="ref-section-heading">
          ...
          <div className="ref-section-intro">
            <p>
              A focused wardrobe of clean silhouettes, easy layers and useful
              colours designed to work together.
            </p>
      ...
      <section className="ref-shell ref-featured">
        <div className="ref-featured-copy">
          ...
          <p>
            Three pieces that carry the whole wardrobe — clean, easy and
      ...
      <section className="ref-shell ref-testimonial-cta">
        <article className="ref-testimonial">
          ...
          <blockquote>
            Clothes should make getting dressed easier, not louder.
          </blockquote>
          <div className="ref-quote-person">
            <span className="ref-avatar">K</span>
            <div>
        ...
        <article className="ref-big-cta">
          ...
          <p>
            Start with the pieces you&apos;ll actually wear every week.
          </p>
          <Link href="/products" className="ref-pill ref-pill-light">
      ...
      <section className="ref-shell ref-arrivals">
        <div className="ref-arrivals-head">
          <div>
            <p className="ref-kicker">NEW ARRIVALS</p>
            <h2>Fresh in.</h2>
          </div>
          <Link href="/products" className="ref-outline-pill">
            View all <span>→</span>
